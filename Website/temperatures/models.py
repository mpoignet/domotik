...
class Sensor(models.Model):
    ...
    sType = models.CharField(max_length=2, choices=SENSOR_TYPE_CHOICES, default='TH')
...
class Actuator(models.Model):
    ...
    address = models.CharField(max_length=100, blank=False, null=False)
    name = models.CharField(max_length=100, blank=True, null=True)
    aType = models.CharField(max_length=2, choices=ACTUATOR_TYPE_CHOICES, default='VA')
...
class Watcher(models.Model):
    ...
    wtype = models.CharField(max_length=3, choices=WATCHER_TYPE_CHOICES, default='EXT')
    sensor = models.ForeignKey(Sensor)
